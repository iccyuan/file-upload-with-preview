...
class R {
  constructor(A, e = {}) {
    ...
    const {
      ...
      multiple: I,
      presetFiles: B,
      showDeleteButtonOnImages: E,
      showSelectFileButton: t
    } = e;
    this.options.showDeleteButtonOnImages = E ?? !0, this.options.maxFileCount = Q ?? 0, this.options.presetFiles = B ?? [], this.options.multiple = I ?? !1, this.options.accept = g ?? this.options.accept, this.options.showSelectFileButton = t ?? !0;
    ...
    this.options.images.baseImage = c ?? this.options.images.baseImage, this.options.images.successPdfImage = m ?? this.options.images.successPdfImage, this.options.images.successVideoImage = h ?? this.options.images.successVideoImage, this.options.images.successFileAltImage = d ?? this.options.images.successFileAltImage, this.options.images.backgroundImage = l ?? this.options.images.backgroundImage, this.addImagesFromPath(this.options.presetFiles), this.imagePreview.style.backgroundImage = `url("${this.options.images.baseImage}")`, this.bindClickEvents();
  }
  bindClickEvents() {
    this.inputHidden.addEventListener(
      ...
      if (e) {
        ...
        if (e.matches(".custom-file-container .image-preview-item")) {
          const g = e.querySelector(".image-preview-item-clear-icon"), Q = g == null ? void 0 : g.getAttribute("data-upload-name"), I = this.cachedFileArray.findIndex(({ name: t }) => t === Q);
          if (I < 0)
            return;
          const B = {
            detail: {
          ...
          }, E = new CustomEvent(i.IMAGE_MULTI_ITEM_CLICKED, B);
  ...
  addFiles(A) {
    ...
    }, I = new CustomEvent(i.FILE_ADDED, Q);
  ...
  deleteFileAtIndex(A) {
    ...
    }, I = new CustomEvent(i.FILE_DELETED, Q);
    window.dispatchEvent(I);
  }
  refreshPreviewPanel() {
    const e = this.imagePreview.querySelectorAll(".image-preview-item");
    Array.from(e).forEach((Q) => Q.classList.add(w)), setTimeout(() => {
  ...
  reset() {
    ...
    }, e = new CustomEvent(i.CLEAR_BUTTON_CLICKED, A);
    window.dispatchEvent(e);
  }
}
export {
  S as DEFAULT_BACKGROUND_IMAGE,
  u as DEFAULT_BASE_IMAGE,
  f as DEFAULT_SUCCESS_FILE_ALT_IMAGE,
  p as DEFAULT_SUCCESS_PDF_IMAGE,
