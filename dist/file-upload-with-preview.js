...
class G {
  constructor(A, g = {}) {
    ...
    const { browse: t, chooseFile: d, label: u, selectedCount: S } = g.text || {};
    this.options.text.chooseFile = d ?? this.options.text.chooseFile, this.options.text.browse = t ?? this.options.text.browse, this.options.text.label = u ?? c, this.options.text.selectedCount = S ?? this.options.text.selectedCount;
    ...
    const { backgroundImage: m, baseImage: h, successFileAltImage: J, successPdfImage: R, successVideoImage: p } = g.images || {};
