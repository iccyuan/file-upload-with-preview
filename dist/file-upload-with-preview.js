...
class G {
  constructor(A, g = {}) {
    ...
    const { browse: t, chooseFile: l, label: c, selectedCount: d } = g.text || {};
    this.options.text.chooseFile = l ?? this.options.text.chooseFile, this.options.text.browse = t ?? this.options.text.browse, this.options.text.label = c ?? n, this.options.text.selectedCount = d ?? this.options.text.selectedCount;
  ...
  `;
    const s = this.el.querySelector(".custom-file-container .input-hidden"), o = this.el.querySelector(".custom-file-container .image-preview"), r = this.el.querySelector(".custom-file-container .clear-button");
    if (s != null && o != null && r != null)
      this.inputHidden = s, this.imagePreview = o, this.clearButton = r;
    else
      throw new Error(`Cannot find all necessary elements for the id: ${this.uploadId}`);
    const { backgroundImage: m, baseImage: S, successFileAltImage: u, successPdfImage: h, successVideoImage: J } = g.images || {};
    this.options.images.baseImage = S ?? this.options.images.baseImage, this.options.images.successPdfImage = h ?? this.options.images.successPdfImage, this.options.images.successVideoImage = J ?? this.options.images.successVideoImage, this.options.images.successFileAltImage = u ?? this.options.images.successFileAltImage, this.options.images.backgroundImage = m ?? this.options.images.backgroundImage, this.addImagesFromPath(this.options.presetFiles), this.imagePreview.style.backgroundImage = `url("${this.options.images.baseImage}")`, this.bindClickEvents();
  }
  bindClickEvents() {
...
export {
  k as DEFAULT_BACKGROUND_IMAGE,
  R as DEFAULT_BASE_IMAGE,
